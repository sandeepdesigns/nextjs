    ...
    <div className="pageWrapper">
      ...
      <section className="pt-24 min-h-[300px] flex items-center bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-600 mt-2">Have some big idea or brand to develop and need help?</p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto p-4">
          ...
          <div className="w-full h-[400px] flex items-center justify-center bg-gray-100">
            ...
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1554629947-334ff61d85dc?auto=format&fit=crop&w=1000&q=80')",
          ...
          <div className="grid lg:grid-cols-5 items-center p-2 [box-shadow:0_2px_10px_-3px_rgba(115,120,131,0.6)] rounded-lg">
                  ...
                  <div className="col-span-full">
                    ...
                    <div className="flex flex-wrap gap-6 mt-4">
                      <div className="flex items-center">
                        <input id="radio1" type="radio" name="value1" className="hidden peer" checked readOnly />
